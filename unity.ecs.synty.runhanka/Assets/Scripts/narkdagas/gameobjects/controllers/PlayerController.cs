...
namespace narkdagas.gameobjects.controllers {
    ...
    public class PlayerController : MonoBehaviour {
        ...
        private void CaptureInput() {
            ...
            moveVector = new Vector3(sideMoveInput, 0, forwardMoveInput);
        }
        ...
        private void GroundedMove() {
            ...
            Vector3 moveDirection = (transform.forward * moveVector.z + transform.right * moveVector.x).normalized;
        ...
        private float VerticalForceCalculation() {
            // Debug.Log($"Controller Grounded? {_characterController.isGrounded} - Vertical Velocity: {verticalVelocity}");
